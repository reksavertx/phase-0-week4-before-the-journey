...
function kaliTerusRekursif(angka) {
  ...
  let hasil = String(angka).split("");

  angka  = 1; // ini harus 1 yaa btw, biar gak ngerubah nilainya
  ...
  return kaliTerusRekursif(angka); // ini posisi angkanya udah berubah yaa. jadi aman gak infinite loop wkwkwkwk
}
